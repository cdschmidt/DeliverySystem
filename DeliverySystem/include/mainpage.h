...
* 
* <p>
* The decorator factory pattern is used in this project to allow the addition of actions to individual objects dynamically 
...
*
* <p>
* Throughout each iteration, we were also really communicative in general 
...
* Carlos : implementation decorator pattern & UML & Test
* Hyunwoo : Documentation & implement CSV reader(not completed) & UML
* David : Documentation & implement Schduler & UML & Test 
* </p>
*/
